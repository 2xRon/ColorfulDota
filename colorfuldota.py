...
def main():
	colordict = {"olive":"\x10","pink":"\x11","red":"\x12","orange":"\x13","darkyellow":"\x14","lightgreen":"\x15","purple":"\x16","grey":"\x17","green":"\x18","blue":"\x19","white":"\x0B","limegreen":"\x0C","hotpink":"\x0E","violet":"\x1A","magenta":"\x1C","yellow":"\x1F","default":"\x06"}
	if len(sys.argv) != 2:
